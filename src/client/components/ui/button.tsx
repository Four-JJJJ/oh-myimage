  ...
  return (
    <button
      ...
      className={cn(
        ...
        size === "xs" && "h-7 rounded-[8px] px-2 text-xs",
        size === "sm" && "h-8 rounded-[12px] px-3 text-sm",
        size === "default" && "h-10 rounded-[12px] px-4",
        size === "lg" && "h-11 rounded-[16px] px-5 text-[15px]",
        size === "icon-xs" && "size-7 rounded-[8px] px-0",
        size === "icon-sm" && "size-8 rounded-[12px] px-0",
        size === "icon" && "size-10 rounded-[12px] px-0",
        ...
        variant === "destructive" && "border-[#ff6b6b]/35 bg-[#ff4050] text-white shadow-[inset_0_1px_0_rgb(255_255_255/0.22)] hover:bg-[#ff4b5a]",
        variant === "destructive-outline" && "border-white/12 bg-transparent text-[#ffd2d2] hover:border-[#ff6b6b]/24 hover:bg-[#ff4f4f]/10 hover:text-[#ffe1e1]",
